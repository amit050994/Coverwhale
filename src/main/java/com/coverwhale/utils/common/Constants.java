...
public static final String USER_DIR = "user.dir";
	...
	public static final String PDF_DOWNLOAD_PATH = System.getProperty(USER_DIR) + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "pdfdocuments";

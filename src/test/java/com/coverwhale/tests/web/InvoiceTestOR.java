...
import com.coverwhale.validators.web.InvoiceDataValidatorOR;
import com.coverwhale.core.QuotePdfReader;
import com.coverwhale.validators.web.quotes.QuoteDataValidatorOR;

public class InvoiceTestOR extends BaseConfiguration {
    ...
    private InvoiceDataValidatorOR invoiceDataValidator;
    private QuoteDataValidatorOR quoteDataValidator;
    ...
    public void setUp() {
        ...
        invoiceDataValidator = new InvoiceDataValidatorOR();
        quoteDataValidator = new QuoteDataValidatorOR();

        webUtils = new WebUtils(driver);
    }

    @Test(testName = "TC_09_01", description = "New Business")
    public void TC_09_01() {
        // Arrange
        Map<String, Object> testData = DataRecorder.getTestData("TC_09_01");
...
//        operationPageActions.selectFederalFilingsForAutoLiability();
        ...
        radiusPageActions.enterUnder50MilesValue();
        ...
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_01", quoteDocNumber);
        quoteDataValidator.validateQuoteDataForTC_09_01();

    }

    @Test(testName = "TC_09_02", description = "Adding a Vehicle")
    public void TC_09_02() {
        ...
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_01", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_01();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_02", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocAdditionalPremiumTaxes("TC_09_02");

    }

    @Test(testName = "TC_09_03", description = "Adding a Trailer")
    public void TC_09_03() {
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_02", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_02();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_03", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocAdditionalPremiumTaxes("TC_09_03");

    }

    @Test(testName = "TC_09_04", description = "Remove a Vehicle")
    public void TC_09_04() {
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_03", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_03();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_04", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocReturnPremiumTaxes("TC_09_04");
    }

    @Test(testName = "TC_09_05", description = "Remove a Trailer")
    public void TC_09_05() {
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_04", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_04();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_05", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocReturnPremiumTaxes("TC_09_05");
    }

    @Test(testName = "TC_09_06", description = "Non Premium Bearing Endorsement")
    public void TC_09_06() {
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_05", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_05();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_06", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocNonPremiumBearingPremium("TC_09_06");
    }


    @Test(testName = "TC_09_07", description = "Cancellation")
    public void TC_09_07() {
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_06", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_06();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_07", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocReturnPremiumTaxes("TC_09_07");
    }

    @Test(testName = "TC_09_08", description = "Request Reinstatement")
    public void TC_09_08() {
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_09_07", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_09_07();
        ...
        submissionStatusButtons.openQuoteDocument();
        webUtils.sleep(8);
        QuotePdfReader.QUOTE_PDF_MAP.put("TC_09_08", previewQuoteDocNumber);
        quoteDataValidator.validateQuoteDocAdditionalPremiumTaxes("TC_09_08");
    }
}
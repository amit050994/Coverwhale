...
import com.coverwhale.validators.web.InvoiceDataValidatorCA;
import com.coverwhale.validators.web.quotes.QuoteDataValidatorCA;
import org.testng.annotations.BeforeClass;
import org.testng.annotations.Test;

import java.util.Map;

public class InvoiceTestCA extends BaseConfiguration {
    ...
    private InvoiceDataValidatorCA invoiceDataValidator;
    private QuoteDataValidatorCA quoteDataValidator;
    ...
    public void setUp() {
        ...
        invoiceDataValidator = new InvoiceDataValidatorCA();
        quoteDataValidator = new QuoteDataValidatorCA();

        webUtils = new WebUtils(driver);
    }

    @Test(testName = "TC_07_01", description = "Adding a Vehicle")
    public void TC_07_01() {
        // Arrange
        Map<String, Object> testData = DataRecorder.getTestData("TC_07_01");
...
//		// Insured page
		...
		QuotePdfReader.QUOTE_PDF_MAP.put("TC_07_01", quoteDocNumber);
		quoteDataValidator.validateQuoteDataForTC_07_01();
       ...
       vehiclePageActions.setVehicleData(VehicleData);
        ...
        submissionStatusButtons.openInvoiceDocument();
     	webUtils.sleep(8);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_01", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_07_01();
     ...
     // open and validate quote document after endorsement
     	...
     	submissionStatusButtons.openQuoteDocument();
     	webUtils.sleep(8);
     	QuotePdfReader.QUOTE_PDF_MAP.put("TC_07_01", previewQuoteDocNumber);
     	quoteDataValidator.validateQuoteDocAdditionalPremiumTaxes_07_01();

    }

    @Test(testName = "TC_07_02", description = "Adding a Trailer")
    public void TC_07_02() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_02", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_02();

    }

    @Test(testName = "TC_07_03", description = "Remove and Add a Vehicle")
    public void TC_07_03() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_03", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_03();


    }

    @Test(testName = "TC_07_04", description = "Remove a Trailer")
    public void TC_07_04() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_04", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_04();
    }

    @Test(testName = "TC_07_05", description = "Non Premium Bearing Endorsement")
    public void TC_07_05() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_05", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_05();
    }


    @Test(testName = "TC_07_06", description = "Cancellation")
    public void TC_07_06() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_06", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_07_06();

    }
    
    
    @Test(testName = "TC_07_07", description = "Request Reinstatement")
    public void TC_07_07() {
        ...
        // Open Invoice document
   		...
   		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_07", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_07();
    }

    @Test(testName = "TC_07_08", description = "Changing Limit Motor Cargo")
    public void TC_07_08() {
        // Arrange
        Map<String, Object> testData = DataRecorder.getTestData("TC_07_08");
        Map<String, String> CargoData = (Map<String, String>) testData.get("Cargo");
        Map<String, String> profileData = (Map<String, String>) testData.get("Profile");
        Map<String, String> quoteData = (Map<String, String>) testData.get("Quote");
        quotePageActions.setQuoteData(quoteData);
...
//		// Insured page
        ...
        // Change Limit Motor Cargo
        reviewPageActions.clickLimitsTab();
        webUtils.sleep(2);
        limitPageActions.selectTowingLabourAndStorageLimit("$25,000");
        limitPageActions.clickNextButton();
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_08", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_08();

    }

    @Test(testName = "TC_07_09", description = "Flat Cancellation ")
    public void TC_07_09() {
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_09", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_07_09();

    }

    @Test(testName = "TC_07_10", description = "Broker Pays Taxes M.J.Hall")
    public void TC_07_10() {
        // Arrange
        Map<String, Object> testData = DataRecorder.getTestData("TC_07_10");
        Map<String, String> CargoData = (Map<String, String>) testData.get("Cargo");
        Map<String, String> profileData = (Map<String, String>) testData.get("Profile");
        Map<String, String> quoteData = (Map<String, String>) testData.get("Quote");
        Map<String, String> producerData = (Map<String, String>) testData.get("Producer");
        quotePageActions.setQuoteData(quoteData);
...
//		// Insured page
        ...
        // Producer page
        producerPageActions.setProducerData((Map<String, String>) testData.get("Producer"));
        producerPageActions.enterFirstName();
        producerPageActions.enterLastName();
        producerPageActions.enterAgencyName();
        producerPageActions.enterAddress();
        producerPageActions.enterCity();
        //producerPageActions.enterCounty();
        producerPageActions.selectState();
        producerPageActions.enterZip();
        producerPageActions.enterPhoneNumber();
        producerPageActions.enterEmailAddress();
        producerPageActions.clickNextButton();
        webUtils.sleep(2);
        // Limits page
        limitPageActions.clickNextButton();
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_10", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_10();

    }

    @Test(testName = "TC_07_11", description = "Adding a Trailer")
    public void TC_07_11() {
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_11", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_11();

    }

    @Test(testName = "TC_07_12", description = "Remove a Vehicle")
    public void TC_07_12() {
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_12", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_12();


    }

    @Test(testName = "TC_07_13", description = "Remove a Trailer")
    public void TC_07_13() {
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_13", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_13();
    }

    @Test(testName = "TC_07_14", description = "Non Premium Bearing Endorsement")
    public void TC_07_14() {
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_14", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_07_14();
    }


    @Test(testName = "TC_07_15", description = "Cancellation")
    public void TC_07_15() {
        ...
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_15", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_07_15();

    }


    @Test(testName = "TC_07_16", description = "Request Reinstatement")
    public void TC_07_16() {
        // Request Reinstatement
        submissionStatusButtons.clickRequestReinstatementButton();
        submissionStatusButtons.clickRequestReinstatementAcknowledgeButton();
        ...
        submissionStatusButtons.openInvoiceDocument();
        webUtils.sleep(5);
        InvoicePDFReader.INVOICE_DOC_MAP.put("TC_07_16", invoiceDocNumber);
        invoiceDataValidator.validatePdfDataForTC_07_16();
    }

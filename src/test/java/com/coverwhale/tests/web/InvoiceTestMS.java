...
import com.coverwhale.validators.web.InvoiceDataValidatorMS;

public class InvoiceTestMS extends BaseConfiguration {
	...
	private InvoiceDataValidatorMS invoiceDataValidator;
	...
	public void setUp() {
		...
		invoiceDataValidator = new InvoiceDataValidatorMS();

		webUtils = new WebUtils(driver);
	}

	@Test(testName = "TC_05_01", description = "Adding a Vehicle")
	public void TC_05_01() {
		// Arrange
		Map<String, Object> testData = DataRecorder.getTestData("TC_05_01");
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_01", invoiceDocNumber);
		
		invoiceDataValidator.validatePdfDataForTC_05_01();

	}
	@Test(testName = "TC_05_02", description = "Adding a Trailer")
	public void TC_05_02() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_02", invoiceDocNumber);

		invoiceDataValidator.validatePdfDataForTC_05_02();

	}

	@Test(testName = "TC_05_03", description = "Remove a Vehicle")
	public void TC_05_03() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_03", invoiceDocNumber);
		
		invoiceDataValidator.validatePdfDataForTC_05_03();

	}

	@Test(testName = "TC_05_04", description = "Remove a Trailer")
	public void TC_05_04() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_04", invoiceDocNumber);

		invoiceDataValidator.validatePdfDataForTC_05_04();
	}

	@Test(testName = "TC_05_05", description = "Cancellation")
	public void TC_05_05() {
		...
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_05", invoiceDocNumber);

		invoiceDataValidator.validatePdfDataForTC_05_05();
	}

    @Test(testName = "TC_05_06", description = "Request Reinstatement")
    public void TC_05_06() {
        ...
        // Open Invoice document
   		...
   		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_06", invoiceDocNumber);

        invoiceDataValidator.validatePdfDataForTC_05_06();
    }

	@Test(testName = "TC_05_07", description = "Changing Values On Trucks")
	public void TC_05_07() {
		// Arrange
		Map<String, Object> testData = DataRecorder.getTestData("TC_05_07");
		Map<String, String> CargoData = (Map<String, String>) testData.get("Cargo");
		Map<String, String> profileData = (Map<String, String>) testData.get("Profile");
		Map<String, String> quoteData = (Map<String, String>) testData.get("Quote");
		quotePageActions.setQuoteData(quoteData);
		...
		vehicleData.put("Value", "95000");
		vehiclePageActions.setVehicleData(vehicleData);
		submissionStatusButtons.clickVehiclesTab();
		webUtils.sleep(2);
		vehiclePageActions.clickChangeOptionsButton();
		webUtils.sleep(2);
		vehiclePageActions.enterVehicleValue();
		vehiclePageActions.clickAddVehicleSaveButton();
		...
		submissionStatusButtons.openInvoiceDocument();
		webUtils.sleep(5);
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_07", invoiceDocNumber);
		invoiceDataValidator.validatePdfDataForTC_05_07();
	}


	@Test(testName = "TC_05_08", description = "Changing Values On Trailers")
	public void TC_05_08() {
		...
		trailerData.put("Trailer Value", "30500");
		trailerPageActions.setTrailerData(trailerData);
		submissionStatusButtons.clickTrailersTab();
		webUtils.sleep(2);
		...
		submissionStatusButtons.openInvoiceDocument();
		webUtils.sleep(3);
		InvoicePDFReader.INVOICE_DOC_MAP.put("TC_05_08", invoiceDocNumber);
		invoiceDataValidator.validatePdfDataForTC_05_08();
	}

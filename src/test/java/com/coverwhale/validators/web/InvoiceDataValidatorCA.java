...
public class InvoiceDataValidatorCA {

	public void validatePdfDataForTC_07_01() {
	...
	public void validatePdfDataForTC_07_02() {
		String invoiceValuesToScrapAL[] = {"Total Policy Cost", "Total Premium - AL",
				"Uninsured/Underinsured Motorists/Property Damage", "Medical Payments", "Policy Fees",
				"Broker Fees", "Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees",
				"Commission - AL", "Net Due to: Cover Whale Insurance Solutions Inc."};
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_02");
		String testCaseId = "TC_07_02";
	...
	public void validatePdfDataForTC_07_03() {
		String invoiceValuesToScrapAL[] = {"Total Policy Cost", "Total Premium - AL",
				"Uninsured/Underinsured Motorists/Property Damage", "Medical Payments", "Policy Fees",
				"Broker Fees", "Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees",
				"Commission - AL", "Net Due to: Cover Whale Insurance Solutions Inc."};
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_03");
		String testCaseId = "TC_07_03";
	...
	public void validatePdfDataForTC_07_04() {
		String invoiceValuesToScrapAL[] = {"Total Policy Cost", "Total Premium - AL",
				"Uninsured/Underinsured Motorists/Property Damage", "Medical Payments", "Policy Fees",
				"Broker Fees", "Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees",
				"Commission - AL", "Net Due to: Cover Whale Insurance Solutions Inc."};
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_04");
		String testCaseId = "TC_07_04";
	...
	public void validatePdfDataForTC_07_05() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_05");
		String testCaseId = "TC_07_05";
	...
	public void validatePdfDataForTC_07_06() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_06");
		String testCaseId = "TC_07_06";
	...
	public void validatePdfDataForTC_07_07() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_07");
		String testCaseId = "TC_07_07";
	...
	public void validatePdfDataForTC_07_08() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_08");
		String testCaseId = "TC_07_08";
	...
	public void validatePdfDataForTC_07_09() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_09");
		String testCaseId = "TC_07_09";
	...
	public void validatePdfDataForTC_07_10() {

		String invoiceValuesToScrapAL[] = {"Total Policy Cost", "Total Premium - AL",
				"Uninsured/Underinsured Motorists/Property Damage", "Medical Payments", "Policy Fees",
				"Broker Fees", "Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees",
				"Commission - AL","Surplus Lines Taxes - Broker to File and Remit Tax", "Stamping Fees - Broker to File and Remit Tax", "Net Due to: Cover Whale Insurance Solutions Inc."};
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_10");
		String testCaseId = "TC_07_10";
		// AL
		Reporter.log("Comparing AL values");
		Map<String, String> invoiceDataFromPdfAL = InvoicePDFReader.getInvoiceData(testCaseId, "AL", invoiceValuesToScrapAL);
		assertion.assertEquals(invoiceDataFromPdfAL.get("Total Policy Cost"), invoiceResults.get("Total Policy Cost_AL"), "Total Policy Cost AL");
		...
		assertion.assertEquals(invoiceDataFromPdfAL.get("Stamping Fees").split("\\)")[1].trim(), invoiceResults.get("Stamping Fees_AL"), "Stamping Fees AL");
		assertion.assertEquals(invoiceDataFromPdfAL.get("Commission - AL").split("\\)")[1].trim(), invoiceResults.get("Commission - AL"), "Commission - AL");
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"  + invoiceDataFromPdfAL.get("Surplus Lines Taxes - Broker to File and Remit Tax") + invoiceResults.get("Surplus Lines Taxes - Broker to File and Remit Tax_AL"));
		System.out.println("####################################"  + invoiceDataFromPdfAL.get("Stamping Fees - Broker to File and Remit Tax") + invoiceResults.get("Stamping Fees - Broker to File and Remit Tax_AL"));
		assertion.assertEquals(invoiceDataFromPdfAL.get("Surplus Lines Taxes - Broker to File and Remit Tax"), invoiceResults.get("Surplus Lines Taxes - Broker to File and Remit Tax_AL"), "Surplus Lines Taxes - Broker to File and Remit Tax_AL");
		assertion.assertEquals(invoiceDataFromPdfAL.get("Stamping Fees - Broker to File and Remit Tax"), invoiceResults.get("Stamping Fees - Broker to File and Remit Tax_AL"), "Stamping Fees - Broker to File and Remit Tax_AL");
		assertion.assertEquals(invoiceDataFromPdfAL.get("Net Due to: Cover Whale Insurance Solutions Inc."), invoiceResults.get("Net Due to: Cover Whale Insurance Solutions Inc._AL"), "Net Due to: Cover Whale Insurance Solutions Inc._AL");
		// APD
		Reporter.log("Comparing APD values");
		String alValuesToScrapAPD[] = {"Total Policy Cost", "Total Premium - APD", "Policy Fees", "Broker Fees",
				"Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees", "Commission - APD","Surplus Lines Taxes - Broker to File and Remit Tax", "Stamping Fees - Broker to File and Remit Tax",
				"Net Due to: Cover Whale Insurance Solutions Inc."};
		Map<String, String> invoiceDataFromPdfAPD = InvoicePDFReader.getInvoiceData(testCaseId, "APD", alValuesToScrapAPD);
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Total Premium - APD"), invoiceResults.get("Total Premium - APD"), "Total Premium - APD");
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Total Policy Cost"), invoiceResults.get("Total Policy Cost_APD"), "Total Policy Cost APD");
		...
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Stamping Fees").split("\\)")[1].trim(), invoiceResults.get("Stamping Fees_APD"), "Stamping Fees APD");
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Commission - APD").split("\\)")[1].trim(), invoiceResults.get("Commission - APD"), "Commission - APD");
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Surplus Lines Taxes - Broker to File and Remit Tax"), invoiceResults.get("Surplus Lines Taxes - Broker to File and Remit Tax_APD"), "Surplus Lines Taxes - Broker to File and Remit Tax_APD");
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Stamping Fees - Broker to File and Remit Tax"), invoiceResults.get("Stamping Fees - Broker to File and Remit Tax_APD"), "Stamping Fees - Broker to File and Remit Tax_APD");
		assertion.assertEquals(invoiceDataFromPdfAPD.get("Net Due to: Cover Whale Insurance Solutions Inc."), invoiceResults.get("Net Due to: Cover Whale Insurance Solutions Inc._APD"), "Net Due to: Cover Whale Insurance Solutions Inc. APD");
		// MTC
		Reporter.log("Comparing MTC values");
		String alValuesToScrapMTC[] = {"Total Policy Cost", "Total Premium - MTC", "Policy Fees", "Broker Fees",
				"Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees", "Commission - MTC","Surplus Lines Taxes - Broker to File and Remit Tax", "Stamping Fees - Broker to File and Remit Tax",
				"Net Due to: Cover Whale Insurance Solutions Inc."};
		Map<String, String> invoiceDataFromPdfMTC = InvoicePDFReader.getInvoiceData(testCaseId, "MTC", alValuesToScrapMTC);
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Total Premium - MTC"), invoiceResults.get("Total Premium - MTC"), "Total Premium - MTC");
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Total Policy Cost"), invoiceResults.get("Total Policy Cost_MTC"), "Total Policy Cost MTC");
		...
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Stamping Fees").split("\\)")[1].trim(), invoiceResults.get("Stamping Fees_MTC"), "Stamping Fees MTC");
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Commission - MTC").split("\\)")[1].trim(), invoiceResults.get("Commission - MTC"), "Commission - MTC");
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Surplus Lines Taxes - Broker to File and Remit Tax"), invoiceResults.get("Surplus Lines Taxes - Broker to File and Remit Tax_MTC"), "Surplus Lines Taxes - Broker to File and Remit Tax_MTC");
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Stamping Fees - Broker to File and Remit Tax"), invoiceResults.get("Stamping Fees - Broker to File and Remit Tax_MTC"), "Stamping Fees - Broker to File and Remit Tax_MTC");
		assertion.assertEquals(invoiceDataFromPdfMTC.get("Net Due to: Cover Whale Insurance Solutions Inc."), invoiceResults.get("Net Due to: Cover Whale Insurance Solutions Inc._MTC"), "Net Due to: Cover Whale Insurance Solutions Inc. MTC");
		// TGL
		Reporter.log("Comparing TGL values");
		String alValuesToScrapTGL[] = {"Total Policy Cost", "Total Premium - TGL", "Policy Fees", "Broker Fees",
				"Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees", "Commission - TGL","Surplus Lines Taxes - Broker to File and Remit Tax", "Stamping Fees - Broker to File and Remit Tax",
				"Net Due to: Cover Whale Insurance Solutions Inc."};
		Map<String, String> invoiceDataFromPdfTGL = InvoicePDFReader.getInvoiceData(testCaseId, "TGL", alValuesToScrapTGL);
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Total Premium - TGL"), invoiceResults.get("Total Premium - TGL"), "Total Premium - TGL");
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Total Policy Cost"), invoiceResults.get("Total Policy Cost_TGL"), "Total Policy Cost TGL");
		...
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Stamping Fees").split("\\)")[1].trim(), invoiceResults.get("Stamping Fees_TGL"), "Stamping Fees TGL");
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Commission - TGL").split("\\)")[1].trim(), invoiceResults.get("Commission - TGL"), "Commission - TGL");
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Surplus Lines Taxes - Broker to File and Remit Tax"), invoiceResults.get("Surplus Lines Taxes - Broker to File and Remit Tax_TGL"), "Surplus Lines Taxes - Broker to File and Remit Tax_TGL");
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Stamping Fees - Broker to File and Remit Tax"), invoiceResults.get("Stamping Fees - Broker to File and Remit Tax_TGL"), "Stamping Fees - Broker to File and Remit Tax_TGL");
		assertion.assertEquals(invoiceDataFromPdfTGL.get("Net Due to: Cover Whale Insurance Solutions Inc."), invoiceResults.get("Net Due to: Cover Whale Insurance Solutions Inc._TGL"), "Net Due to: Cover Whale Insurance Solutions Inc. TGL");
		// NTL
		Reporter.log("Comparing NTL values");
		String alValuesToScrapNTL[] = {"Total Policy Cost", "Total Premium - NTL", "Policy Fees", "Broker Fees",
				"Underwriting Fees", "Surplus Lines Taxes", "Stamping Fees", "Commission - NTL","Surplus Lines Taxes", "Stamping Fees", "Commission - NTL","Surplus Lines Taxes - Broker to File and Remit Tax", "Stamping Fees - Broker to File and Remit Tax",
				"Net Due to: Cover Whale Insurance Solutions Inc."};
		Map<String, String> invoiceDataFromPdfNTL = InvoicePDFReader.getInvoiceData(testCaseId, "NTL", alValuesToScrapNTL);
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Total Premium - NTL"), invoiceResults.get("Total Premium - NTL"), "Total Premium - NTL");
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Total Policy Cost"), invoiceResults.get("Total Policy Cost_NTL"), "Total Policy Cost NTL");
		...
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Stamping Fees").split("\\)")[1].trim(), invoiceResults.get("Stamping Fees_NTL"), "Stamping Fees NTL");
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Commission - NTL").split("\\)")[1].trim(), invoiceResults.get("Commission - NTL"), "Commission - NTL");
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Surplus Lines Taxes - Broker to File and Remit Tax"), invoiceResults.get("Surplus Lines Taxes - Broker to File and Remit Tax_NTL"), "Surplus Lines Taxes - Broker to File and Remit Tax_NTL");
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Stamping Fees - Broker to File and Remit Tax"), invoiceResults.get("Stamping Fees - Broker to File and Remit Tax_NTL"), "Stamping Fees - Broker to File and Remit Tax_NTL");
		assertion.assertEquals(invoiceDataFromPdfNTL.get("Net Due to: Cover Whale Insurance Solutions Inc."), invoiceResults.get("Net Due to: Cover Whale Insurance Solutions Inc._NTL"), "Net Due to: Cover Whale Insurance Solutions Inc. NTL");
		assertion.assertAll();

	}

	public void validatePdfDataForTC_07_11() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_11");
		String testCaseId = "TC_07_11";
	...
	public void validatePdfDataForTC_07_12() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_12");
		String testCaseId = "TC_07_12";
	...
	public void validatePdfDataForTC_07_13() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_13");
		String testCaseId = "TC_07_13";
	...
	public void validatePdfDataForTC_07_14() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_14");
		String testCaseId = "TC_07_14";
	...
	public void validatePdfDataForTC_07_15() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_15");
		String testCaseId = "TC_07_15";
	...
	public void validatePdfDataForTC_07_16() {
		...
		SoftAssert assertion = new SoftAssert();
		Map<String, String> invoiceResults = (Map<String, String>) DataRecorder.INVOICE_RESULT_CACHE.get("TC_07_16");
		String testCaseId = "TC_07_16";

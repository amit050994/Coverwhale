...
public class QuoteDataValidatorPA {

	public void validateQuoteDataForTC_06_01() {
		QuotePdfReader quoteReader = new QuotePdfReader();
		SoftAssert assertion = new SoftAssert();
		String testCaseId = "TC_06_01";
		...
		String alPremiumDetailLabelsToScrap[] = { "Automobile Liability", "Premium Subtotal",
				"Personal Injury Protection", "Uninsured/Underinsured Motorists/Property Damage"};
		...
		assertion.assertEquals(ALDataFromPDF.get("Personal Injury Protection"), quoteResults.get("AL_PD_Personal Injury Protection"), "AL PD_Personal Injury Protection");  // PD : Premium detail table
		assertion.assertEquals(ALDataFromPDF.get("Uninsured/Underinsured Motorists/Property Damage"), quoteResults.get("AL_PD_Uninsured/Underinsured Motorists/Property Damage"), "AL PD_Uninsured/Underinsured Motorists/Property Damage");  // PD : Premium detail table
